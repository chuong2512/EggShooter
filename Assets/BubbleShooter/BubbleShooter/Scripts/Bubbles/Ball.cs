...
public class Ball : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            float totalVelocity = Vector3.Magnitude(rb.linearVelocity);
            if (totalVelocity > 20)
            {
                float tooHard = totalVelocity / (20);
                rb.linearVelocity /= tooHard;
            ...
            else if (totalVelocity < 15)
            {
                ...
                if (tooSlowRate != 0)
                    rb.linearVelocity /= tooSlowRate;
            }
            if (rb.linearVelocity.y < 1.5f && rb.linearVelocity.y > 0)
                rb.linearVelocity = new Vector2(rb.linearVelocity.x, 1.7f);
    ...
    public void StartFall()
    {
        ...
        gameObject.GetComponent<Rigidbody2D>().linearVelocity = gameObject.GetComponent<Rigidbody2D>().linearVelocity + new Vector2(UnityEngine.Random.Range(-2, 2), 0);
    ...
    void SwitchVelocity()
    {
        ...
        if (touchTheBorder && targetBall != null)
        {
            ...
            rb.linearVelocity = (target - transform.position).normalized * 10;
        }
    }
